...
| [Skills](https://github.com/Deepidoo-s-new-age/.github/blob/main/README.md#skills-déquipe) | `/new-module`, `/new-project`, `/update-module-contract`, `/review-module`, `/pr-automation` |
| [PR Automation](https://github.com/Deepidoo-s-new-age/.github/blob/main/docs/PR-AUTOMATION.md) | Review PR + YAML + Talkspirit (Cursor Automation) |
