...
| [docs/TEAM-RULES.md](docs/TEAM-RULES.md) | Règles d’équipe appliquées aux devs et aux agents (à titre indicatif) |
| [docs/RULES-CATALOG.md](docs/RULES-CATALOG.md) | Catalogue : contenu, mode d’application et portée de chaque règle |
| [docs/rules/](docs/rules) | Texte intégral des règles globales |
